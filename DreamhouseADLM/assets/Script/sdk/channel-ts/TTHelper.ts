...
export default class TTHelper extends BaseHelper {
    ...
    constructor() {
        ...
        this.sdk = new lc_sdk();
        this.sdk.initSdkByConf({ channel: "tt", appId: "tt7f5709eae06e1f8202", secret: ""});
        this.login()
        this.loadConfig()
    }
